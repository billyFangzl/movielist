...
export class MoviesService {
  ...
  private api_key ='2124d5d37b102693f431fbb690af5e4d';
  ...
  getUpcomingMovies(){
    return this._http.get(this.movie_url+'discover/movie?primary_release_date.gte=2019-04-29&primary_release_date.lte=2019-07-31' + '&api_key=' + this.api_key);
  }
